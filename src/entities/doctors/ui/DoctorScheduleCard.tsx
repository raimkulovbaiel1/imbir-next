...
export default function DoctorScheduleCard({
  ...
  return (
    <div className="rounded-[20px] bg-[#bfe4ff] p-5">
      ...
      <Link
        href={href}
        className="mt-5 flex w-full items-center gap-2 rounded-full bg-white px-4 py-3 text-[17px] font-semibold text-[#0C2647] shadow-sm"
      >
        <span className="flex h-6 w-6 rounded-full text-white">
          <img src={schedule.src} alt="schedule" />
        </span>
