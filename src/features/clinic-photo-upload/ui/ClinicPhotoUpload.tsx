    ...
    <div className="w-full max-w-[150px]">
      <div className="relative h-[180px] w-[180px] overflow-hidden rounded-[4px] border-2 border-[#B9E8FF] bg-white">
        {preview && (
          <img
            src={preview}
            alt="Фото клиники" className="relative h-[180px] w-[180px] overflow-hidden rounded-[4px] border border-[#75CFF0] bg-white"
          />
        ) || (
...
export default ClinicPhotoUpload;