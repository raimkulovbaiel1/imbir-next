...
import { WORK_DAYS } from "@/entities/Procedure-form/model/procedure-form.data";
import type { WorkSchedule } from "@/entities/Procedure-form/model/types";

const ProcedureWorkSchedule = () => {
...
export default ProcedureWorkSchedule;